...
instantGiveWeapon()
{
    ...
    self setColour( self.instantWeap, self getCurrentMenu(), self getCursor() );
}
...
dropWeapons()
{
    ...
    self setColour( self.dropWeap, self getCurrentMenu(), self getCursor() );
}
...
do_modded_bullets( bullet )
{
    ...
    if( !isDefined( self.modded_bullets ) || self.current_bullet != bullet )
    {
        ...
        {
            if(isDefined( self.optColour[ self getCurrentMenu() + e ] ))
                self setColour( undefined, self getCurrentMenu(), e ); 
        }
        self setColour( self.modded_bullets );    
...
do_custom_bullet()
{
    if(!IsDefined( self.custom_bullet ))
    {
        ...
        self setColour( self.custom_bullet );
